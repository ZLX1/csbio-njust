...
if __name__ == '__main__':
    ...
    for gamma in np.logspace(-10,10,21):
        for beta in np.logspace(-10,10,21):
            ...
            for train_index, validation_index in KF.split(x_train):
                ...
                Y_train_proj, Q_train_proj = cal_projections(x_train_t, y_train_t, 0, beta, gamma, k_d)
                ...
                # Y_test_proj, Q_test_proj = cal_projections(x_train_v, y_train_v, 0, beta, gamma, k_d)
    ...
    datapath1 = 'D:\\MachineLearning\\correct_b_r_k4.csv'
