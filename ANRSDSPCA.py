...
def cal_projections(X_data,B_data,k_d):
    ...
    Y, Q = ANRSDSPCA_Algorithm(X_data.transpose(), B_data.transpose(), M, 0.2, 0.5, 0.5, k_d, nclass, n)
    # Y, Q = ANRSDSPCA_Algorithm(X_data.transpose(), B_data.transpose(), M, 0.1, 0.5, 0.5, k_d, nclass, n)
    # Y, Q = ANRSDSPCA_Algorithm(X_data.transpose(), B_data.transpose(), M, 0.2, 0.5, 1.5, k_d, nclass, n)
    # Y, Q = ANRSDSPCA_Algorithm(X_data.transpose(), B_data.transpose(), M, 0.2, 0.1, 1.5, k_d, nclass, n)
    # Y, Q = ANRSDSPCA_Algorithm(X_data.transpose(), B_data.transpose(), M, 0.2, 0.1, 1e2, k_d, nclass, n)
