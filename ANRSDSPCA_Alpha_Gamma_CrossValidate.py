...
if __name__ == '__main__':
    ...
    for alpha in np.logspace(-10,10,21):
        for gamma in np.logspace(-10,10,21):
            ...
            for train_index, validation_index in KF.split(x_train):
                x_train_t = x_train[train_index]#400，20502
                x_train_v = x_train[validation_index]#100，20502
                y_train_t = y_train[train_index]#400，4
                y_train_v = y_train[validation_index]#100，4
                Y_train_proj, Q_train_proj = cal_projections(x_train_t, y_train_t, alpha, 0, gamma, k_d)#20502，4 400，4
                ...
                # Y_test_proj, Q_test_proj = cal_projections(x_train_v, y_train_v, alpha, 0, gamma, k_d)#20502，4 100，4
    ...
    datapath1 = 'D:\\MachineLearning\\correct_a_r_k4.csv'
